...
final List<Category> mainCategories = [
  ...
  Category(name: 'جلابيب'),
  Category(name: 'جينز'),
  Category(name: 'رياضة'),
  Category(name: 'كاجوال'),
  Category(name: 'تيشيرت'),
  Category(name: 'لانجري'),
  Category(name: 'أخرى'),
];

class Womanclothes extends StatefulWidget {
  const Womanclothes({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          languageProvider.translate('womenClothes.title'),
                  ...
                  ? StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        return Center(
                          child: Text(
                            languageProvider.translate('womenClothes.loading'),
                            style: GoogleFonts.cairo(fontSize: width * 0.04),
                          ),
                        );
                      }
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: height * 0.005),
                                          Text(
                                            '${product['price']} ${languageProvider.translate('womenClothes.price')}',
                                            style: GoogleFonts.cairo(
                                              fontSize: width * 0.035,
                                              fontWeight: FontWeight.bold,
                                              color: const Color(0xff44A2E6),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: FilterChip(
              label: Text(
                languageProvider.translate('womenClothes.${category.name}'),
                style: GoogleFonts.cairo(
