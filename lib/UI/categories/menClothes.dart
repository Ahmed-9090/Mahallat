...
import '../seller_pages/products_seller_home.dart';
...
final List<Category> mainCategories = [
  ...
  Category(name: 'بناطيل قماش'),
  Category(name: 'بناطيل كارغو'),
  Category(name: 'رياضة'),
  Category(name: 'قمصان'),
  Category(
    name: 'تيشيرتات وبلايز',
    subCategories: [
      'Round Neck',
      'V-Neck',
      'Polo',
...
class Menclothes extends StatefulWidget {
  const Menclothes({super.key});

  @override
  State<Menclothes> createState() => _MenclothesState();
}
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: FilterChip(
              label: Text(
                languageProvider.translate('menClothes.${category.name}'),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: FilterChip(
              label: Text(
                languageProvider.translate('menClothes.subCategories.${subCategory}'),
                style: GoogleFonts.cairo(
                  fontSize: width * 0.035,
                  color: isSelected ? Colors.white : const Color(0xff503636),
                  fontWeight: isSelected ? FontWeight.bold : FontWeight.normal,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          languageProvider.translate('menClothes.title'),
          style: GoogleFonts.cairo(
            fontSize: width * 0.05,
                ...
                child: ClipRRect(
                  ...
                  child: _isVideoInitialized && _videoController.value.isInitialized
                      ...
                      : Container(
                          ...
                          child: Center(
                            child: Text(
                              languageProvider.translate('menClothes.loading'),
                              style: GoogleFonts.cairo(
                                fontSize: width * 0.04,
                              ),
                            ),
                  ...
                  ? StreamBuilder<QuerySnapshot>(
                    stream:
                        FirebaseFirestore.instance
                            .collection('stores')
                            .where('categories', arrayContains: 'Men Clothing')
                            .snapshots(),
                    builder: (context, snapshot) {
                      if (snapshot.hasError) {
                        return Center(
                          child: Text(
                            languageProvider.translate('menClothes.errorLoading'),
                            style: GoogleFonts.cairo(
                              fontSize: width * 0.04,
                            ),
                          ),
                                          ...
                                          onPressed: () async {
                                            ...
                                            style:
                                                            ...
                                                            TextButton(
                                                              ...
                                                              child: Text(
                                                                        languageProvider.translate('womenClothes.yes'),
                                            ...
                                            style:
                                              ...
                                              if (context.mounted) {
                                                ScaffoldMessenger.of(
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      languageProvider.translate('womenClothes.errorLoading'),
          ...
          MaterialPageRoute(
            builder:
                (context) => ProductsSellerHome(
                  sellerId: store.sellerId,
                  availableCollections: store.storeTypes,
                  initialCollection: 'menClothes',
                ),
          ),
        );
      },
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: getStatusColor(store.status).withOpacity(0.9),
                    borderRadius: BorderRadius.circular(20),
                    boxShadow: [
                      BoxShadow(
