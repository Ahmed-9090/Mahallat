...
final List<Category> mainCategories = [
  Category(name: 'العناية بالجسم'),
  Category(name: 'العناية بالشعر'),
...
class Healthandcare extends StatefulWidget {
  const Healthandcare({super.key});

  @override
  State<Healthandcare> createState() => _HealthandcareState();
}

class _HealthandcareState extends State<Healthandcare> {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: FilterChip(
              label: Text(
                languageProvider.translate('healthAndCare.${category.name}'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          languageProvider.translate('healthAndCare.title'),
          style: GoogleFonts.cairo(
            fontSize: width * 0.05,
                  ...
                  ? StreamBuilder<QuerySnapshot>(
                    stream:
                        FirebaseFirestore.instance
                            ...
                            .where(
                              'categories',
                              arrayContains: 'Health And Beauty',
                            )
                            .snapshots(),
                  ...
                  : StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        return Center(
                          child: Text(
                            languageProvider.translate('healthAndCare.loading'),
                            style: GoogleFonts.cairo(fontSize: width * 0.04),
                          ),
                        );
                      }
                                                        ...
                                                        builder:
                                                            (
                                                              ...
                                                              content: Text(
                                                                languageProvider
                                                                    .translate(
                                                                      'healthAndCare.clearCartMessage',
                                                                    ),
                                                                style:
                                                                    GoogleFonts.cairo(),
                                                              ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 2),
                                          Text(
                                            '${product['price']} ${languageProvider.translate('healthAndCare.price')}',
                                            style: GoogleFonts.cairo(
                                              fontSize: 13,
                                              fontWeight: FontWeight.bold,
                                              color: Color(0xff44A2E6),
              ...
              StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (products.isEmpty) {
                    return Center(
                      child: Text(
                        languageProvider.translate('healthAndCare.noProducts'),
                        style: GoogleFonts.cairo(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: Colors.grey,
  ...
  void _addToCart() async {
    ...
    if (user == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            languageProvider.translate('healthAndCare.pleaseLogin'),
            style: GoogleFonts.cairo(),
          ),
    ...
    try {
      ...
      if (!sameStore) {
        ...
        final shouldClearCart = await showDialog<bool>(
          ...
          builder:
              (context) => AlertDialog(
                title: Text(
                  languageProvider.translate('healthAndCare.alert'),
                  style: GoogleFonts.cairo(),
                ),
                content: Text(
                  languageProvider.translate('healthAndCare.clearCartMessage'),
                  style: GoogleFonts.cairo(),
                ),
                actions: [
                  TextButton(
                    ...
                    child: Text(
                      languageProvider.translate('healthAndCare.no'),
                      style: GoogleFonts.cairo(),
                    ),
                  ),
                  TextButton(
                    ...
                    child: Text(
                      languageProvider.translate('healthAndCare.yes'),
                      style: GoogleFonts.cairo(),
                    ),
                  ),
                ],
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              languageProvider.translate('healthAndCare.addedToCart'),
              style: GoogleFonts.cairo(),
            ),
            duration: const Duration(seconds: 2),
          ),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              languageProvider.translate('healthAndCare.error'),
              style: GoogleFonts.cairo(),
            ),
            duration: const Duration(seconds: 2),
          ),
...
class HealthAndCareProductDetails extends StatelessWidget {
  final Map<String, dynamic> product;
  final String storeName;
  const HealthAndCareProductDetails({
    Key? key,
