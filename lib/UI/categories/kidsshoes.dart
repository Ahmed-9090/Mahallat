      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: FilterChip(
              label: Text(
                languageProvider.translate('kidsShoes.${category.name}'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          languageProvider.translate('kidsShoes.title'),
          style: GoogleFonts.cairo(
            fontSize: width * 0.05,
                ...
                child: ClipRRect(
                  ...
                  child: _isVideoInitialized && _videoController.value.isInitialized
                      ...
                      : Container(
                          ...
                          child: Center(
                            child: Text(
                              languageProvider.translate('kidsShoes.loading'),
                              style: GoogleFonts.cairo(
                                fontSize: width * 0.04,
                              ),
                            ),
                  ...
                  ? StreamBuilder<QuerySnapshot>(
                    stream:
                        FirebaseFirestore.instance
                            .collection('stores')
                            .where('categories', arrayContains: 'Kids Shoes')
                            .snapshots(),
                    builder: (context, snapshot) {
                      if (snapshot.hasError) {
                        return Center(
                          child: Text(
                            languageProvider.translate('kidsShoes.errorLoading'),
                            style: GoogleFonts.cairo(
                              fontSize: width * 0.04,
                            ),
                          ),
